...
openSettingsDialog()
{
  ...
  ; Create tab control
  Gui, Settings:Add, Tab2, w450 h500, Hotkeys||OCR|Speech Recognition|Output
  ...
  Gui, Settings:Add, GroupBox, x20 y120 w120 h345, Valid Keys
  ...
  Gui, Settings:Add, GroupBox, x150 y35 w300 h380, OCR Hotkeys
  ...
  Gui, Settings:Add, Edit, xp-90 yp+25 r1 w80 vOptOcrPreProcessingKey, %OcrPreProcessingKey%
  Gui, Settings:Add, Text, xp+90, Toggle OCR pre-processing
  Gui, Settings:Add, Edit, xp-90 yp+25 r1 w80 vOptTextDirectionToggleKey, %TextDirectionToggleKey%
  Gui, Settings:Add, Text, xp+90, Toggle text direction (horizontal/vertical)
  Gui, Settings:Add, Text, yp+15, for Chinese/Japanese

  Gui, Settings:Add, GroupBox, x150 y420 w300 h75, Speech Recognition Hotkeys
  Gui, Settings:Add, Edit, xp+10 yp+20 r1 w80 vOptStartVoiceCapture, %StartVoiceCapture%
  Gui, Settings:Add, Text, xp+90, Start capture
  Gui, Settings:Add, Edit, xp-90 yp+25 r1 w80 vOptVoiceLanguageToggleKey, %VoiceLanguageToggleKey%
  Gui, Settings:Add, Text, xp+90, Toggle active language

  ; -- OCR tab ----------
  Gui, Settings:Tab, OCR
  Gui, Settings:Add, GroupBox, x20 y35 w210 h50, Current OCR Language
  dropDownitems := getLangDropdown(dictionary)
  Gui, Settings:Add, DropDownList, xp+10 yp+20 vOptDictionary Sort W190, %dropDownitems%

  Gui, Settings:Add, GroupBox, x20 y90 w210 h110, Quick-Access OCR Languages
  ...
  Gui, Settings:Add, GroupBox, x20 y205 w210 h90, Capture Box
  ...
  Gui, Settings:Add, GroupBox, x20 y300 w430 h65, Text Direction
  Gui, Settings:Add, Text, xp+10 yp+20, This option is only used for Japanese and Chinese.
  dropDownitems := getFormattedDropdown("Horizontal|Vertical", TextDirection, Horizontal)
  Gui, Settings:Add, DropDownList, yp+15 vOptTextDirection w100, %dropDownitems%

  Gui, Settings:Add, GroupBox, x20 y370 w430 h65, Whitelist
  Gui, Settings:Add, Text, xp+10 yp+20, Force the OCR engine to recognize only the following subset of characters:
  Gui, Settings:Add, Edit, yp+15 w400 vOptWhitelist, %Whitelist%
  
  Gui, Settings:Add, GroupBox, x20 y440 w430 h45, OCR Pre-Processing
  ...
  ; -- Speech tab ----------
  Gui, Settings:Tab, Speech

  Gui, Settings:Add, GroupBox, x20 y35 w430 h50, Current Speech Recognition Language
  voiceLangList := getVoiceLangList()
  dropDownitems := getFormattedDropdown(voiceLangList, VoiceLanguage, English (United States))
  Gui, Settings:Add, DropDownList,  xp+10 yp+20 vOptVoiceLanguage w190, %dropDownitems%

  Gui, Settings:Add, GroupBox, x20 y90 w430 h80, Quick-Access Speech Recognition Languages
  Gui, Settings:Add, Text, xp+10 yp+20, Slot 1:
  dropDownitems := getFormattedDropdown(voiceLangList, VoiceLanguage1, Japanese)
  Gui, Settings:Add, DropDownList, xp+40 vOptVoiceLanguage1 Sort W190, %dropDownitems%
  Gui, Settings:Add, Text, xp-40 yp+30, Slot 2:
  dropDownitems := getFormattedDropdown(voiceLangList, VoiceLanguage2, English (United States))
  Gui, Settings:Add, DropDownList, xp+40 vOptVoiceLanguage2 Sort W190, %dropDownitems%

  Gui, Settings:Add, GroupBox, x20 y175 w430 h110, Results Window
  Gui, Settings:Add, Text, xp+10 yp+20, Number of results:
  dropDownitems := getFormattedDropdown("1|2|3|4|5|6|7|8|9", VoiceMaxResults, 9)
  Gui, Settings:Add, DropDownList, vOptVoiceMaxResults w70 xp+100, %dropDownitems%
  Gui, Settings:Add, Text, xp-100 yp+30, Font family:
  Gui, Settings:Add, Edit, xp+100 r1 w120 vOptVoiceResultsWindowFont, %VoiceResultsWindowFont%
  Gui, Settings:Add, Text, xp-100 yp+30, Font size:
  dropDownitems := getFormattedDropdown("8|9|10|11|12|14|16|18|20|22|24|26|28|36|48|72", VoiceResultsWindowFontSize, 12)
  Gui, Settings:Add, DropDownList, xp+100 vOptVoiceResultsWindowFontSize w70, %dropDownitems%

  Gui, Settings:Add, GroupBox, x20 y290 w430 h50, Recording Options
  Gui, Settings:Add, Text, xp+10 yp+20, Silence before stop:
  dropDownitems := getFormattedDropdown("0.3|0.4|0.5|0.6|0.7|0.8|0.9|1.0|1.2|1.4|1.6|1.8|2.0", VoiceSilenceBeforeStop, 0.5)
  Gui, Settings:Add, DropDownList, xp+100 vOptVoiceSilenceBeforeStop w70, %dropDownitems%
  Gui, Settings:Add, Text, xp+80, seconds
...
saveSettingsGUI()
{
  ...
  ; Voice Specific
  IniWrite, %OptVoiceMaxResults%, %SETTINGS_FILE%, VoiceSpecific, VoiceMaxResults
  IniWrite, %OptVoiceResultsWindowWidth%, %SETTINGS_FILE%, VoiceSpecific, VoiceResultsWindowWidth
  IniWrite, %OptVoiceResultsWindowFont%, %SETTINGS_FILE%, VoiceSpecific, VoiceResultsWindowFont
  IniWrite, %OptVoiceResultsWindowFontSize%, %SETTINGS_FILE%, VoiceSpecific, VoiceResultsWindowFontSize
  IniWrite, %OptVoiceSilenceBeforeStop%, %SETTINGS_FILE%, VoiceSpecific, VoiceSilenceBeforeStop
  IniWrite, %OptVoiceLanguage%, %SETTINGS_FILE%, VoiceSpecific, VoiceLanguage
  IniWrite, %OptVoiceLanguage1%, %SETTINGS_FILE%, VoiceSpecific, VoiceLanguage1
  IniWrite, %OptVoiceLanguage2%, %SETTINGS_FILE%, VoiceSpecific, VoiceLanguage2
  ...
  IniWrite, %OptOcrPreProcessingKey%, %SETTINGS_FILE%, Hotkeys, OcrPreProcessingKey
  IniWrite, %OptTextDirectionToggleKey%, %SETTINGS_FILE%, Hotkeys, TextDirectionToggleKey
  IniWrite, %OptStartVoiceCapture%, %SETTINGS_FILE%, Hotkeys, StartVoiceCapture
  IniWrite, %OptVoiceLanguageToggleKey%, %SETTINGS_FILE%, Hotkeys, VoiceLanguageToggleKey
...
; list         - A pipe seperated list of options
